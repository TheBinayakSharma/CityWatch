...
public class SampleData {
    ...
    c1Task.setAssignedTo(o2.getOrgId()); c1Task.setCompletedBy(o2.getOrgId());
    Task c2Task = new Task("Free Health Camp", "Organize free health checkup camp");
    c2Task.setAssignedTo(o4.getOrgId()); c2Task.setCompletedBy(o4.getOrgId());
    Task c3Task = new Task("Library Setup", "Set up small community library");
    c3Task.setAssignedTo(o3.getOrgId()); c3Task.setCompletedBy(o3.getOrgId());
    Task c4Task = new Task("Tree Mapping", "Map trees in public parks");
    c4Task.setAssignedTo(o1.getOrgId()); c4Task.setCompletedBy(o1.getOrgId());
    Task c5Task = new Task("Clean Water Awareness", "Educate about water hygiene");
    c5Task.setAssignedTo(o5.getOrgId()); c5Task.setCompletedBy(o5.getOrgId());
