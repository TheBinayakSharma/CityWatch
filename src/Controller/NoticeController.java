...
public class NoticeController {
    ...
    /**
     * Creates a new notice Adds the notice to the storage and updates the
     * recent notices queue
     *
     * @param title the notice title
     * @param desc the notice description
     * @throws Exception if a notice with the same title and description already
     * exists
     */
